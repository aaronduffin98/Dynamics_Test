...
function AddFieldPanel({ entityKey, fieldIds, onAdd }) {
  ...
  const handleSubmit = (e) => {
    ...
    const fieldValue =
      controlType === "dropdown"
        ...
        : value.trim() || "—";
    onAdd(entityKey, fieldIds, trimmed, fieldValue, controlType, options);
    setLabel("");
    setValue("");
    ...
    return (
      <div className="mda-detail-columns">
        <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
          ...
          <AddFieldPanel entityKey={entityKey} fieldIds={baseFieldIds} onAdd={addCustomField} />
          <button
            type="button"
